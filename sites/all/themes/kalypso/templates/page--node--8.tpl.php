...
<div class="span10">
         ...
         <div class="row">
            ...
            <div class="carousel-inner">
              <div class="active item"><img src="<?php echo $root; ?>/preview/970x400.gif" alt="slider"></div>
              <div class="item"><img src="<?php echo $root; ?>/preview/970x400.gif" alt="slider">
              <div class="carousel-caption">
                      <h4>This is a caption</h4>
                      <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                    </div>
              </div> 
              <div class="item"><img src="<?php echo $root; ?>/preview/970x400.gif" alt="slider"></div> 
            </div>
            <!-- Carousel nav -->
